    ...
    return (
        <>
            <div className='container' style={{ color: props.mode === "dark" ? "white" : "#042743" }}>
                ...
                <button type="button" className="btn btn-danger mx-2" onClick={handleUpClick} >Convert to UpperCase</button>
            ...
            <div className="container my-3" style={{ color: props.mode === "dark" ? "white" : "#042743" }}>
                ...
                <p>{text.trim() === "" ? "0 words and 0 characters" : `${text.trim().split(/\s+/).length} words and ${text.length} characters`}</p>
                <p>{0.008 * text.trim().split(/\s+/).length} Minutes to read this text.</p>
                <h2>Preview: </h2>
